...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="SubscriptionPlansList">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${p.period} <c:if test="${p.period==1}">Year</c:if><c:if test="${p.period !=1}">Years</c:if></td>
                                            <td>Rs ${p.amount}</td>
                                            <td>${p.noOfBooks}</td>
                                            <td>${p.status}</td>
                                        </tr>
    ...
    $(document).ready(function() {
        $('#SubscriptionPlansList').dataTable();
    });
