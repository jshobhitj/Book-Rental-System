...
<body>
    ...
    <div id="wrapper">
                ...
                <li>
					<div id="MainMenu">
    					...
    					<div id="demo3" style="margin-left:15px">
      						...
      						<a href="<c:url value="/adminAdminUserCancelledRequests"/>" class="a:active"><span class="glyphicon glyphicon-th"></span> Cancelled Requests</a>
		...
		<div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Cancelled Requests List</h1>
                        <div id="pendingList">
                        <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Cancelled Delivery</b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="cancelledDeliveryList">
                                    <thead>
                                        <tr>
                                            <th>User Name</th>
                                            <th>ISBN Code</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="p" items="${cancelledDelivery}">
                                        <tr>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Cancelled Return</b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="cancelledReturnList">
                                    <thead>
                                        <tr>
                                            <th>User Name</th>
                                            <th>ISBN Code</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="p" items="${cancelledReturn}">
                                        <tr>
                                            <td>${p.userDetails.firstName} ${p.userDetails.lastName}</td>
                                            <td>${p.bookCatalogue.isbnCode} </td>
                                            <td>${p.userDetails.userId}</td>
    ...
    $(document).ready(function() {
        $('#cancelledDeliveryList').dataTable();
    });
    $(document).ready(function() {
        $('#cancelledReturnList').dataTable();
    });
